...
class DiariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diary" do
    assert_difference('Diary.count') do
      post diaries_url, params: { diary: { date: @diary.date, detail: @diary.detail, name: @diary.name } }
    end
  ...
  test "should update diary" do
    patch diary_url(@diary), params: { diary: { date: @diary.date, detail: @diary.detail, name: @diary.name } }
